...
exports.default = function () {
  var playerData = _lib2.default.returnDatabaseObject('players', 'p_0');
  ...
  _lib2.default.generatePlayer(playerData);
  _lib2.default.movePlayer(_lib2.default.getElement(playerData.id), (0, _jquery2.default)('#t_0_0 #cell_3_3'));
};
...
exports.default = function (currentCell, direction) {
  var destinationCell = undefined;
  var cellIndex = (0, _jquery2.default)(currentCell).index();

  if (direction === 'north') {
    destinationCell = (0, _jquery2.default)(currentCell).closest('tr').prev().children().eq(cellIndex);
  }
  if (direction === 'east') {
    destinationCell = (0, _jquery2.default)(currentCell).next();
  }
  if (direction === 'south') {
    destinationCell = (0, _jquery2.default)(currentCell).closest('tr').next().children().eq(cellIndex);
  }
  if (direction === 'west') {
    destinationCell = (0, _jquery2.default)(currentCell).prev();
  }

  if (!(0, _jquery2.default)(destinationCell).is('td')) {
    console.log('ERROR: tried to return an OUT OF BOUNDS cell');return;
  }
...
exports.default = function (div) {
  if (!(0, _jquery2.default)(div).is('div')) {
    console.log('ERROR: trying to FIND CELL WITH INVALID DIV');return;
  }
  return (0, _jquery2.default)(div).closest('td');
};
...
exports.default = function (database, inputId) {
  if (database === 'tables') {
    return tables[database][inputId];
  }
  if (database === 'players') {
    return players[database][inputId];
  }
};

var _tables = require('../data/tables.json');
...
var _createDatabaseObject2 = _interopRequireDefault(_createDatabaseObject);

var _generateTableHtml = require('./generateTableHtml');

var _generateTableHtml2 = _interopRequireDefault(_generateTableHtml);

var _initGame = require('./initGame');

var _initGame2 = _interopRequireDefault(_initGame);
...
exports.default = {
  'initGame': _initGame2.default,
  'generateTableHtml': _generateTableHtml2.default,
  'generatePlayer': _generatePlayer2.default,
